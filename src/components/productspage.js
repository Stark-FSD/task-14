    ...
    return (
      <Navbar id ="navbar" expand="lg" className="bg-body-tertiary">
        <Container className="container1">
          <Navbar.Brand href="#home">Dope</Navbar.Brand>
    ...
    return(
        ...
        <div className="container px-4 px-lg-5 my-5">
            <div className="text-center text-white">
                <h1 className="display-4 fw-bolder">Dope Products Hub</h1>
                <p className="lead fw-normal text-white-50 mb-0">Grab your Loot</p>
            </div>
        </div>
    </header>
    );
